...
class ResourceListItemSerializer(serializers.Serializer):
    ...
    resource_title = serializers.CharField(max_length=200, required=False)
    ...
    doi = serializers.CharField(max_length=200, required=False)
    date_created = serializers.DateTimeField(format='%m-%d-%Y', required=False)
    date_last_updated = serializers.DateTimeField(format='%m-%d-%Y', required=False)
    ...
    bag_url = serializers.URLField(required=False)
    science_metadata_url = serializers.URLField(required=False)
    resource_map_url = serializers.URLField(required=False)
